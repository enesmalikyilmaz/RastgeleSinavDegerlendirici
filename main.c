  ...
  int main()
{
    ...
    char secenekler[5]="ABCDE";

    printf("Ogrenci sayisini giriniz (max 10): ");
    scanf("%d",&N);

    printf("Soru sayisini giriniz (max 10): ");
    scanf("%d",&S);
    ...
    char gecici[S][100],harf_notu[201];
    double Ortalama,Standart_sapma,T_skoru[N],ham_basari_notu[N];
